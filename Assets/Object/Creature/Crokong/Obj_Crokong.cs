...
public class Obj_Crokong : MonoBehaviour
{
                        ...
                        else //---Attack
                        {
                            if (!GetComponent<Animator>().GetBool("Is_Attacking") && !GetComponent<Animator>().GetBool("Attacked"))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        case 1:
                                            Floor_creater.GetComponent<Floor_crtater>().Floor_Find(Attack_Target.transform.position + Vector3.up, GetComponent<Object_Normal>().Class_Now).GetComponent<Floor_Normal>().Tool_Effect("Knock", 30, gameObject);
                                            Floor_creater.GetComponent<Floor_crtater>().Floor_Find(Attack_Target.transform.position, GetComponent<Object_Normal>().Class_Now).GetComponent<Floor_Normal>().Tool_Effect("Knock", 30, gameObject);
                                            Floor_creater.GetComponent<Floor_crtater>().Floor_Find(Attack_Target.transform.position - Vector3.up, GetComponent<Object_Normal>().Class_Now).GetComponent<Floor_Normal>().Tool_Effect("Knock", 30, gameObject);
                                            break;
                                        case 2:
                                            Floor_creater.GetComponent<Floor_crtater>().Floor_Find(Attack_Target.transform.position + Vector3.up, GetComponent<Object_Normal>().Class_Now).GetComponent<Floor_Normal>().Tool_Effect("Knock", 30, gameObject);
                                            ...
                                            break;
                                        case 3:
                                            Floor_creater.GetComponent<Floor_crtater>().Floor_Find(Attack_Target.transform.position + Vector3.right, GetComponent<Object_Normal>().Class_Now).GetComponent<Floor_Normal>().Tool_Effect("Knock", 30, gameObject);
                                            Floor_creater.GetComponent<Floor_crtater>().Floor_Find(Attack_Target.transform.position, GetComponent<Object_Normal>().Class_Now).GetComponent<Floor_Normal>().Tool_Effect("Knock", 30, gameObject);
                                            Floor_creater.GetComponent<Floor_crtater>().Floor_Find(Attack_Target.transform.position - Vector3.right, GetComponent<Object_Normal>().Class_Now).GetComponent<Floor_Normal>().Tool_Effect("Knock", 30, gameObject);
                                            break;
                                        case 4:
    ...
    */
    ...
    void Find_Enemy()
    {
        ...
        for (int i = -3; i <= 3; i++)
        {
            for (int j = -3; j <= 3; j++)
            {
                if (!Floor_creater.GetComponent<Floor_crtater>().Floor_Find(transform.position + Vector3.right * i + Vector3.up * j, GetComponent<Object_Normal>().Class_Now).GetComponent<Floor_Normal>().Is_Empty)
                {
                    _temp = Floor_creater.GetComponent<Floor_crtater>().Floor_Find(transform.position + Vector3.right * i + Vector3.up * j, GetComponent<Object_Normal>().Class_Now).GetComponent<Floor_Normal>().Object_Up;
                    if (_temp != gameObject)
                    {
                        if (_temp.name == "Player")
                        {
                            Anger = 10;
                            if (!_finded)
                            {
                            ...
                            else if (Vector3.Distance(_temp_f.transform.position, transform.position) > Vector3.Distance(_temp.transform.position, transform.position))
                            {
                                _temp_f = _temp;
                            }
                        }
                        else if (Floor_creater.GetComponent<Floor_crtater>().Floor_Find(transform.position + Vector3.right * i + Vector3.up * j, GetComponent<Object_Normal>().Class_Now).GetComponent<Floor_Normal>().Object_Up.GetComponent<Object_Normal>().Type == "Creature")
                        {
                            Anger = 10;
                            if (!_finded)
                            {
