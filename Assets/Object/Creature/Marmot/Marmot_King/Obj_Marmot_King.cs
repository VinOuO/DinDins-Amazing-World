...
public class Obj_Marmot_King : MonoBehaviour
{
    GameObject Calender;
    bool Is_Closing = false;
    public GameObject Cave;
    public int Shoot_Rock_Over = 3;
    ...
    void Update()
    {
        ...
        if (Floor_Stand[4] == null)
        {
            for (int i = -1,p=0; i <= 1; i++)
            {
                for (int j = -1; j <= 1; j++)
                {
                    Floor_Stand[p] = Floor_creater.GetComponent<Floor_crtater>().Floor_Find(transform.position + Vector3.right * i + Vector3.up * j, GetComponent<Object_Normal>().Class_Now);
                    if (!Floor_Stand[p].GetComponent<Floor_Normal>().Is_Empty)
                    {
                        Destroy(Floor_Stand[p].GetComponent<Floor_Normal>().Object_Up);
                    }
                    Floor_Stand[p].GetComponent<Floor_Normal>().Is_Empty = false;
                    Floor_Stand[p].GetComponent<Floor_Normal>().Object_Up = gameObject;
                    p++;
                }
            }
            Floor_Change();
            ...
            if (GetComponent<Object_Normal>().cc_Round == 0)
            {
                ...
                switch (Move_State)
                {
                    case "None":
                        ...
                        break;
                    case "Searching":
                        if (Vector3.Distance(Floor_Stand[4].transform.position, Floor_creater.GetComponent<Floor_crtater>().Floor_Find(Target, GetComponent<Object_Normal>().Class_Now).transform.position) < 1 && Floor_Stand[4].transform.position == transform.position)
                        {
                    ...
                    case "Attacking":
                        ...
                        if (Shoot_Round != Calender.GetComponent<Calendar>().Round)
                        {
                            if (Rock_Num <= 0)
                            {
                                if (Vector3.Distance(Floor_Stand[4].transform.position, Floor_creater.GetComponent<Floor_crtater>().Floor_Find(Attack_Target.transform.position, GetComponent<Object_Normal>().Class_Now).transform.position) <= 3 && Floor_Stand[4].transform.position == transform.position)
                                {
                            ...
                            else
                            {
                                if (!Is_Digging)
                                {
                                    if (transform.position.y == Attack_Target.transform.position.y)
                                    {
                                        ...
                                        {
                                            Dir = 1;
                                            Rock = Instantiate(Rock_Bullet, transform.position + 2 * Vector3.left + Vector3.up, transform.rotation);
                                            ...
                                            Rock = Instantiate(Rock_Bullet, transform.position + 2 * Vector3.left, transform.rotation);
                                            Rock.GetComponent<Rock_Bullet>().Dir = Dir;
                                            Rock.GetComponent<Rock_Bullet>().Shooter = gameObject;
                                            Rock.GetComponent<Rock_Bullet>().Is_Out_Of_Screen = Is_Out_Of_Screen;
                                            Rock = Instantiate(Rock_Bullet, transform.position + 2 * Vector3.left + Vector3.down, transform.rotation);
                                            Rock.GetComponent<Rock_Bullet>().Dir = Dir;
                                            Rock.GetComponent<Rock_Bullet>().Shooter = gameObject;
                                            Rock.GetComponent<Rock_Bullet>().Is_Out_Of_Screen = Is_Out_Of_Screen;
                                        }
                                        ...
                                        {
                                            Dir = 2;
                                            Rock = Instantiate(Rock_Bullet, transform.position + 2 * Vector3.right + Vector3.up, transform.rotation);
                                            Rock.GetComponent<Rock_Bullet>().Dir = Dir;
                                            Rock.GetComponent<Rock_Bullet>().Shooter = gameObject;
                                            Rock.GetComponent<Rock_Bullet>().Is_Out_Of_Screen = Is_Out_Of_Screen;
                                            Rock = Instantiate(Rock_Bullet, transform.position + 2 * Vector3.right, transform.rotation);
                                            Rock.GetComponent<Rock_Bullet>().Dir = Dir;
                                            Rock.GetComponent<Rock_Bullet>().Shooter = gameObject;
                                            Rock.GetComponent<Rock_Bullet>().Is_Out_Of_Screen = Is_Out_Of_Screen;
                                            Rock = Instantiate(Rock_Bullet, transform.position + 2 * Vector3.right + Vector3.down, transform.rotation);
                                            Rock.GetComponent<Rock_Bullet>().Dir = Dir;
                                            Rock.GetComponent<Rock_Bullet>().Shooter = gameObject;
                                            Rock.GetComponent<Rock_Bullet>().Is_Out_Of_Screen = Is_Out_Of_Screen;
                                        }
                                    ...
                                    else if (transform.position.x == Attack_Target.transform.position.x)
                                    {
                                        ...
                                        {
                                            Dir = 3;
                                            Rock = Instantiate(Rock_Bullet, transform.position + 2 * Vector3.up + Vector3.right, transform.rotation);
                                            Rock.GetComponent<Rock_Bullet>().Dir = Dir;
                                            Rock.GetComponent<Rock_Bullet>().Shooter = gameObject;
                                            Rock.GetComponent<Rock_Bullet>().Is_Out_Of_Screen = Is_Out_Of_Screen;
                                            Rock = Instantiate(Rock_Bullet, transform.position + 2 * Vector3.up, transform.rotation);
                                            Rock.GetComponent<Rock_Bullet>().Dir = Dir;
                                            Rock.GetComponent<Rock_Bullet>().Shooter = gameObject;
                                            Rock.GetComponent<Rock_Bullet>().Is_Out_Of_Screen = Is_Out_Of_Screen;
                                            Rock = Instantiate(Rock_Bullet, transform.position + 2 * Vector3.up + Vector3.left, transform.rotation);
                                            Rock.GetComponent<Rock_Bullet>().Dir = Dir;
                                            Rock.GetComponent<Rock_Bullet>().Shooter = gameObject;
                                            Rock.GetComponent<Rock_Bullet>().Is_Out_Of_Screen = Is_Out_Of_Screen;
                                        }
                                        ...
                                        {
                                            Dir = 4;
                                            Rock = Instantiate(Rock_Bullet, transform.position + 2 * Vector3.down + Vector3.right, transform.rotation);
                                            Rock.GetComponent<Rock_Bullet>().Dir = Dir;
                                            Rock.GetComponent<Rock_Bullet>().Shooter = gameObject;
                                            Rock.GetComponent<Rock_Bullet>().Is_Out_Of_Screen = Is_Out_Of_Screen;
                                            Rock = Instantiate(Rock_Bullet, transform.position + 2 * Vector3.down, transform.rotation);
                                            Rock.GetComponent<Rock_Bullet>().Dir = Dir;
                                            Rock.GetComponent<Rock_Bullet>().Shooter = gameObject;
                                            Rock.GetComponent<Rock_Bullet>().Is_Out_Of_Screen = Is_Out_Of_Screen;
                                            Rock = Instantiate(Rock_Bullet, transform.position + 2 * Vector3.down + Vector3.left, transform.rotation);
                                            Rock.GetComponent<Rock_Bullet>().Dir = Dir;
                                            Rock.GetComponent<Rock_Bullet>().Shooter = gameObject;
                                            Rock.GetComponent<Rock_Bullet>().Is_Out_Of_Screen = Is_Out_Of_Screen;
                                        }
    ...
    public void Move(Vector3 _Destination)
    {
        if (Vector3.Distance(transform.position, _Destination) > 0.1f)
        {
            if (transform.position.x != _Destination.x)
            {
                if (transform.position.x < _Destination.x)
                {
                    if (Floor_creater.GetComponent<Floor_crtater>().Floor_Find(_Destination, GetComponent<Object_Normal>().Class_Now).GetComponent<Floor_Normal>().Is_Empty || !Floor_creater.GetComponent<Floor_crtater>().Floor_Find(_Destination, GetComponent<Object_Normal>().Class_Now).GetComponent<Floor_Normal>().Is_Edge)
                    {
                        if (!Is_Out_Of_Screen)
                        {
    ...
    void Floor_Change()
    {
        for (int i = 0; i <= 8; i++)
        {
            Floor_Stand[i].GetComponent<Floor_Normal>().Is_Empty = true;
            Floor_Stand[i].GetComponent<Floor_Normal>().Object_Up = null;
        }
        ...
        for(int i = -1,p = 0; i <= 1; i++)
        {
            ...
            {
                Floor_Stand[p] = Floor_creater.GetComponent<Floor_crtater>().Floor_Find(transform.position + Vector3.right * i + Vector3.up * j, GetComponent<Object_Normal>().Class_Now);
                if (!Floor_Stand[p].GetComponent<Floor_Normal>().Is_Empty && Floor_Stand[p].GetComponent<Floor_Normal>().Object_Up!=gameObject)
                {
                    Destroy(Floor_Stand[p].GetComponent<Floor_Normal>().Object_Up);
                }
                Floor_Stand[p].GetComponent<Floor_Normal>().Is_Empty = false;
    ...
    void Dig_Random()
    {
        ...
        if (_try <= 30)
        {
            temp.x = (int)Math.Round(temp.x);
            temp.y = (int)Math.Round(temp.y);
            temp.z = (int)Math.Round(temp.z);
            transform.position = temp;
            Floor_Change();
        }
    }
    ...
    private void OnDestroy()
    {
        ...
        if (!Is_Closing)
        {
            ...
            if (GetComponent<Object_Normal>().Health <= 0)
            {
                _temp = Instantiate(Cave, transform.position, transform.rotation);
                GetComponent<Object_Normal>().Floor_creat.GetComponent<Floor_crtater>().Floor_Find(transform.position, GetComponent<Object_Normal>().Class_Now).GetComponent<Floor_Normal>().Object_Up = _temp;
                GetComponent<Object_Normal>().Floor_creat.GetComponent<Floor_crtater>().Floor_Find(transform.position, GetComponent<Object_Normal>().Class_Now).GetComponent<Floor_Normal>().Is_Empty = false;
                _temp.name = Cave.name;
            }
