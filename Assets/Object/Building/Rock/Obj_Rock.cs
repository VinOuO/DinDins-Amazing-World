...
public class Obj_Rock : MonoBehaviour {

    public GameObject rock, temp;
    ...
    private void OnDestroy()
    {
        if (!Is_Closing)
        {
            ...
            {
                temp = Instantiate(rock, transform.position, transform.rotation, GetComponent<Object_Normal>().Floor_creat.GetComponent<Floor_crtater>().Floor_Find(transform.position, GetComponent<Object_Normal>().Class_Now).transform);
